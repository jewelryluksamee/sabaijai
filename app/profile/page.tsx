      ...
      <main className="pt-8 pb-32 px-6 max-w-5xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <div
              className="rounded-xl p-8 flex flex-col justify-between shadow-sm relative overflow-hidden grainy-texture flex-1"
              style={{ backgroundColor: total > 0 ? dominantConfig.chartColor + "30" : "#d4e8c8" }}
            >
              <div className="relative z-10">
                <span
                  className="px-3 py-1 rounded-full shadow-sm text-[10px] font-bold uppercase tracking-widest"
          ...
          >
            <div className="w-12 h-12 rounded-full bg-white/20 shadow-sm flex items-center justify-center">
          ...
          <div className="md:col-span-8 bg-white rounded-xl p-8 shadow-sm grainy-texture">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 bg-[#c2e3c8]/40 rounded-lg shadow-sm">
          ...
          {criticalRiskCount > 0 && (
            <div className="md:col-span-12 bg-white rounded-xl p-8 shadow-sm grainy-texture relative overflow-hidden">
              <style>{`
                @keyframes gr-core {
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-5 gap-2">
                    {[
                      ...
                      <div key={num} className="flex flex-col items-center gap-2 p-3 rounded-xl shadow-sm bg-[#fdf5f5] text-center">
                        <div className="w-8 h-8 rounded-full bg-red-100 shadow-sm flex items-center justify-center text-sm font-bold text-red-700">
                          {num}
                        </div>
          ...
          {/* AI Insight */}
          <div className="md:col-span-12 bg-[#f5eed8] rounded-xl p-8 space-y-6 relative shadow-sm">
                ...
                <ul className="space-y-2">
                  {aiInsight.tips.map((tip, i) => (
                    <li key={i} className="flex gap-3 text-sm text-[#6b5e4d]">
                      <span className="w-5 h-5 rounded-full bg-[#d4e8c8] shadow-sm text-[#4a6b45] flex items-center justify-center shrink-0 text-[10px] font-bold">
                        {i + 1}
                      </span>
                      <span>{tip}</span>
                    </li>
        ...
        {/* AI Quote */}
        <section className="bg-[#e8d8a8]/20 rounded-xl p-10 text-center relative overflow-hidden group shadow-sm grainy-texture">
